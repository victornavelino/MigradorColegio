...
import Entidades.Medico.TipoSocio;
...
public class TipoSocioJpaController implements Serializable {
    ...
    public TipoSocioJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void edit(TipoSocio tipoSocio) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public TipoSocio findTipoSocio(Long id) {
        EntityManager em = getEntityManager();
        try {
